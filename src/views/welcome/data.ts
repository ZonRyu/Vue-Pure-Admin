...
/** Number of people in need, number of questions asked, number of answers, and user satisfaction */
const chartData = [
  {
    icon: GroupLine,
    bgColor: "#effaff",
    color: "#41b6ff",
    duration: 2200,
    name: "Number of people required",
    value: 36000,
    percent: "+88%",
    data: [2101, 5288, 4239, 4962, 6752, 5208, 7450] // Smoothing Line Chart Data
  },
  {
    icon: Question,
    bgColor: "#fff5f4",
